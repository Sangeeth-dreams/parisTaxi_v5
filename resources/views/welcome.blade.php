...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/welcome_fonts/icomoon/style.css') }}">

    <link rel="stylesheet" href="{{ asset('css/welcome_css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/welcome_css/magnific-popup.css') }}">
    <link rel="stylesheet" href="{{ asset('css/welcome_css/jquery-ui.css') }}">
    <link rel="stylesheet" href="{{ asset('css/welcome_css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/welcome_css/owl.theme.default.min.css') }}">


    <link rel="stylesheet" href="{{ asset('css/welcome_css/aos.css') }}">

    <link rel="stylesheet" href="{{ asset('css/welcome_css/style.css') }}">
...
<body class="antialiased">
    ...
    <div class="site-navbar py-2">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                <div class="logo">
                    <div class="site-logo">
                        <a href="index.html" class="js-logo-clone">12/7</a>
                    </div>
                </div>
    ...
    <div class="site-blocks-cover" style="background-image: url({{url('img/welcome_images/hero_1.jpg')}});">
        <div class="container">
            <div class="row">
                <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
                    <div class="site-block-cover-content text-center">
                        <h2 class="sub-title">Fresh Foods, New Foods Everyday</h2>
                        <h1>12/7</h1>
                        <p>
            ...
            <div class="row align-items-stretch section-overlap">
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="banner-wrap bg-primary h-100">
                        <a href="#" class="h-100">
                            <h5>Pick up<br> Medicines</h5>
                            <p>
                                Pick up your Midicines
                                <strong>Whatsapp your prescription and pick it without a delay.</strong>
                            </p>
                        </a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="banner-wrap h-100">
                        <a href="#" class="h-100">
                            <h5>Senior citizen <br> 10% Off </h5>
                            <p>
                                10% OFF for senior citizens
                                <strong>You are a Above 60 year citizen, serve the prescription and get your 10% OFF
                                </strong>
                            </p>
                        </a>
                    </div>
                    ...
                    <div class="banner-wrap bg-warning h-100">
                        <a href="#" class="h-100">
                            ...
                            <p>
                                ...
                                <strong>Send us the prescription and your details through whatsapp. </strong>
                            </p>
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4 text-center item mb-4">
                    ...
                    <a href="shop-single.html"> <img src="img/welcome_images/asamodagam.jpg" alt="Image"></a>
                    <h3 class="text-dark"><a href="shop-single.html">Asamodagam</a></h3>
                    <p class="price"><del>Rs.95.00</del> &mdash; Rs.85.00</p>
                </div>
                <div class="col-sm-6 col-lg-4 text-center item mb-4">
                    <a href="shop-single.html"> <img src="img/welcome_images/Panadol.jpg" alt="Image"></a>
                    <h3 class="text-dark"><a href="shop-single.html">Panadol</a></h3>
                    <p class="price">Rs.170.00</p>
                </div>
                <div class="col-sm-6 col-lg-4 text-center item mb-4">
                    <a href="shop-single.html"> <img src="img/welcome_images/product_03.png" alt="Image"></a>
                ...
                <div class="col-sm-6 col-lg-4 text-center item mb-4">
                    ...
                    <a href="shop-single.html"> <img src="img/welcome_images/product_04.png" alt="Image"></a>
                    <h3 class="text-dark"><a href="shop-single.html">Cetyl Pure</a></h3>
                    <p class="price"><del>45.00</del> &mdash; $20.00</p>
                </div>
                <div class="col-sm-6 col-lg-4 text-center item mb-4">
                    <a href="shop-single.html"> <img src="img/welcome_images/product_05.png" alt="Image"></a>
                    <h3 class="text-dark"><a href="shop-single.html">CLA Core</a></h3>
                    <p class="price">$38.00</p>
                </div>
                <div class="col-sm-6 col-lg-4 text-center item mb-4">
                    <span class="tag">Sale</span>
                    <a href="shop-single.html"> <img src="img/welcome_images/product_06.png" alt="Image"></a>
            ...
            <div class="row">
                <div class="col-md-12 block-3 products-wrap">
                    <div class="nonloop-block-3 owl-carousel">
                        ...
                        <div class="text-center item mb-4">
                            <a href="shop-single.html"> <img src="img/welcome_images/product_02.png" alt="Image"></a>
                            <h3 class="text-dark"><a href="shop-single.html">Umcka Cold Care</a></h3>
                            <p class="price">$120.00</p>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12 block-3 products-wrap">
                    <div class="nonloop-block-3 no-direction owl-carousel">
                        ...
                        <div class="testimony">
                            <blockquote>
                                <img src="img/welcome_images/person_1.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
                        ...
                        <div class="testimony">
                            <blockquote>
                                <img src="img/welcome_images/person_2.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
                                <p>&ldquo;Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo omnis
                        ...
                        <div class="testimony">
                            <blockquote>
                                <img src="img/welcome_images/person_3.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
                                <p>&ldquo;Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo omnis
                                    voluptatem consectetur quam tempore
                                    obcaecati maiores voluptate aspernatur iusto eveniet, placeat ab quod tenetur
                                    ducimus. Minus ratione sit quaerat
                        ...
                        <div class="testimony">
                            <blockquote>
                                <img src="img/welcome_images/person_4.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
                                <p>&ldquo;Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo omnis
                                    voluptatem consectetur quam tempore
                                    obcaecati maiores voluptate aspernatur iusto eveniet, placeat ab quod tenetur
                                    ducimus. Minus ratione sit quaerat
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6">
                    <div class="block-16">
                        <figure>
                            <img src="img/welcome_images/bg_1.jpg" alt="Image placeholder" class="img-fluid rounded">
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-6 order-md-2">
                    <div class="block-16">
                        <figure>
                            <img src="img/welcome_images/hero_1.jpg" alt="Image placeholder" class="img-fluid rounded">
                            <a href="https://vimeo.com/channels/staffpicks/93951774"
                                class="play-button popup-vimeo"><span class="icon-play"></span></a>
                ...
                <div class="col-md-5 mr-auto">
                    ...
                    <p class="text-black">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius repellat, dicta
                        at laboriosam, nemo
                        exercitationem itaque eveniet architecto cumque, deleniti commodi molestias repellendus quos
                        sequi hic fugiat
                        asperiores illum. Atque, in, fuga excepturi corrupti error corporis aliquam unde nostrum quas.
    ...
    <div class="site-section bg-secondary bg-image"
        style="background-image: url({{url('img/welcome_images/bg_2.jpg')}});">
        <div class="container">
            <div class="row align-items-stretch">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <a href="#" class="banner-1 h-100 d-flex"
                        style="background-image: url({{url('img/welcome_images/bg_1.jpg')}});">
...
<script src="{{ asset('js/welcome_js/jquery-3.3.1.min.js') }}"></script>
<script src="{{ asset('js/welcome_js/jquery-ui.js') }}"></script>
<script src="{{ asset('js/welcome_js/popper.min.js') }}"></script>
<script src="{{ asset('js/welcome_js/bootstrap.min.js') }}"></script>
<script src="{{ asset('js/welcome_js/owl.carousel.min.js') }}"></script>
<script src="{{ asset('js/welcome_js/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('js/welcome_js/aos.js') }}"></script>
